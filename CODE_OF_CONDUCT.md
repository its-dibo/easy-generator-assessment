...
1- if you're using Windows, use wsl to install Ubuntu or any other debian-based Linux disto.
...
- we use jira (or any other management system) for issue tracking.
